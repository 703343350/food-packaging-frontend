...
function FoodCont() {
  ...
  function handleSearch(e) {
    axios.get("http://localhost:4000/chatgpt?food=" + input).then((res) => {
    ...
    if (data.hasOwnProperty("recipe")) {
      ...
      setRes(
        data.restaurants.map((item) => (
          <Link
            to="/foodDetail"
            state={{ img: data.image, name: item.name, price: item.price }}>
            <FoodBox imgSrc={data.image} title={item.name} price={item.price} />
          </Link>
        ))
      );
        ...
        {search && (
          <div className="left-side">
            <div className="cards">
              ...
              <br />
              <div>
                <h3 style={{ fontSize: "29px", fontWeight: "800" }}>
                  <u>RECIPE: {name}</u>
                </h3>
                <br />
                <div
                  ...
                  style={{
                    backgroundImage: `url(${ingred})`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                    border: "5px solid #FE555F",
                    padding: "20px",
                    borderRadius: "6px",
                    marginTop: "12px",
                  }}>
                ...
                <div
                  className="ingredients"
                  style={{
                    backgroundImage: `url(${ingredien})`,
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: "center",
                    backgroundSize: "cover",
                    border: "5px solid #a5a4a9",
                    padding: "20px",
                    borderRadius: "6px",
                    marginTop: "12px",
                  }}>
              ...
              <p>
                <u style={{ fontSize: "23px", fontWeight: "700" }}>
